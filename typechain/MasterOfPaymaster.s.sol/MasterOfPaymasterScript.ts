...
export interface MasterOfPaymasterScriptInterface extends utils.Interface {
  functions: {
...
export interface MasterOfPaymasterScript extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MasterOfPaymasterScriptInterface;
