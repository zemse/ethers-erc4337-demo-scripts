...
export interface AccountAbstractionBaseTestInterface extends utils.Interface {
  functions: {
...
export interface AccountAbstractionBaseTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccountAbstractionBaseTestInterface;
