...
export interface NftFullSubsidyPaymasterInterface extends utils.Interface {
  functions: {
    "addNft(address)": FunctionFragment;
    ...
    "removeNft(address)": FunctionFragment;
...
export interface NftFullSubsidyPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NftFullSubsidyPaymasterInterface;
