...
export interface NftFullSubsidyPaymasterTestInterface extends utils.Interface {
  functions: {
    ...
    "hashExternal((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes))": FunctionFragment;
    "revertWithSenderAddressExternal(bytes)": FunctionFragment;
    "setUp()": FunctionFragment;
    "testSampleTx()": FunctionFragment;
    "testSubsidizedTx()": FunctionFragment;
    "vm()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getRequestId"
      | "hashExternal"
      | "revertWithSenderAddressExternal"
      | "setUp"
      | "testSampleTx"
      | "testSubsidizedTx"
      | "vm"
  ...
  encodeFunctionData(
    functionFragment: "hashExternal",
    values: [UserOperationStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "revertWithSenderAddressExternal",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(functionFragment: "setUp", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "testSampleTx",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testSubsidizedTx",
    values?: undefined
  ): string;
...
export interface NftFullSubsidyPaymasterTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NftFullSubsidyPaymasterTestInterface;
  ...
  callStatic: {
    ...
    testSampleTx(overrides?: CallOverrides): Promise<void>;

    testSubsidizedTx(overrides?: CallOverrides): Promise<void>;
