...
export interface MasterOfPaymasterTestInterface extends utils.Interface {
  functions: {
...
export interface MasterOfPaymasterTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MasterOfPaymasterTestInterface;
