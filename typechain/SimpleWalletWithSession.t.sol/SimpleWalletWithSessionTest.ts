...
export interface SimpleWalletWithSessionTestInterface extends utils.Interface {
  functions: {
    ...
    "testOwnerCreatesSession()": FunctionFragment;
    "vm()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testOwnerCreatesSession",
    values?: undefined
  ): string;
...
export interface SimpleWalletWithSessionTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleWalletWithSessionTestInterface;
  ...
  callStatic: {
    ...
    testOwnerCreatesSession(overrides?: CallOverrides): Promise<void>;
