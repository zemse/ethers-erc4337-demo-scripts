...
export interface SimpleWalletTestInterface extends utils.Interface {
  functions: {
...
export interface SimpleWalletTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleWalletTestInterface;
