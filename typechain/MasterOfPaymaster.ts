...
export interface MasterOfPaymasterInterface extends utils.Interface {
  functions: {
...
export interface MasterOfPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MasterOfPaymasterInterface;
